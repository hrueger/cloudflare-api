 ...
 * 
 * @export
 * @interface C4f8RoOSAppsComponentsSchemasIdResponse
 */
export interface C4f8RoOSAppsComponentsSchemasIdResponse extends C4f8RoOSApiResponseSingle {
    /**
     * 
     * @type {C4f8RoOSAppsComponentsschemasidResponseResult}
     * @memberof C4f8RoOSAppsComponentsSchemasIdResponse
     */
