 ...
 * 
 * @export
 * @interface Model6KaSmMdRCollectionRoleResponse
 */
export interface Model6KaSmMdRCollectionRoleResponse extends Model6KaSmMdRApiResponseCollection {
    /**
     * 
     * @type {Array<Model6KaSmMdRSchemasRole>}
     * @memberof Model6KaSmMdRCollectionRoleResponse
     */
    result?: Array<Model6KaSmMdRSchemasRole>;
}
