...
import { Tm1HTKEcSingleResponse } from './tm1-htkec-single-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX357
 */
export interface InlineResponse4XX357 extends Tm1HTKEcSingleResponse {
    /**
     * 
     * @type {Tm1HTKEcMessages}
     * @memberof InlineResponse4XX357
     */
