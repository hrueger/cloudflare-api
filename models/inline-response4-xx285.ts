...
import { Model2UOufITZSchemasIdResponse } from './model2-uouf-itzschemas-id-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX285
 */
export interface InlineResponse4XX285 extends Model2UOufITZSchemasIdResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX285
     */
