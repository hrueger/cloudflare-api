 ...
 * @export
 * @interface VXFDQCwXLocationStrategy
 */
export interface VXFDQCwXLocationStrategy {
    /**
     ...
     * @type {string}
     * @memberof VXFDQCwXLocationStrategy
     */
    mode?: VXFDQCwXLocationStrategyModeEnum;
    /**
     ...
     * @memberof VXFDQCwXLocationStrategy
     */
    preferEcs?: VXFDQCwXLocationStrategyPreferEcsEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum VXFDQCwXLocationStrategyModeEnum {
    Pop = 'pop',
...
/**
    ...
    * @enum {string}
    */
export enum VXFDQCwXLocationStrategyPreferEcsEnum {
    Always = 'always',
    Never = 'never',
    Proximity = 'proximity',
    Geo = 'geo'
