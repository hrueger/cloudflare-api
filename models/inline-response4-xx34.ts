...
import { Tm1HTKEcCreateResponse } from './tm1-htkec-create-response';
import { Tm1HTKEcMessages } from './tm1-htkec-messages';
/**
 * 
 * @export
 * @interface InlineResponse4XX34
 */
export interface InlineResponse4XX34 extends Tm1HTKEcCreateResponse {
    /**
     * 
     * @type {Tm1HTKEcMessages}
     * @memberof InlineResponse4XX34
     */
