...
import { Model2UOufITZDisableTransferResponse } from './model2-uouf-itzdisable-transfer-response';
import { Model2UOufITZMessages } from './model2-uouf-itzmessages';
/**
 * 
 * @export
 * @interface InlineResponse4XX278
 */
export interface InlineResponse4XX278 extends Model2UOufITZDisableTransferResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX278
     */
