...
import { Tm1HTKEcAutoRedirectToIdentity } from './tm1-htkec-auto-redirect-to-identity';
import { Tm1HTKEcCustomPages } from './tm1-htkec-custom-pages';
 ...
 * 
 * @export
 * @interface AccessOrganizationsBody
 */
export interface AccessOrganizationsBody {
    /**
     * 
     * @type {Tm1HTKEcAuthDomain}
     * @memberof AccessOrganizationsBody
     */
    authDomain?: Tm1HTKEcAuthDomain;
    /**
     * 
     * @type {Tm1HTKEcAutoRedirectToIdentity}
     * @memberof AccessOrganizationsBody
     */
    autoRedirectToIdentity?: Tm1HTKEcAutoRedirectToIdentity;
    /**
     * 
     * @type {Tm1HTKEcCustomPages}
     * @memberof AccessOrganizationsBody
     */
    customPages?: Tm1HTKEcCustomPages;
    /**
     * 
