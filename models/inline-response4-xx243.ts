...
import { AuJBhWMyListZoneScriptsResponse } from './au-jbh-wmy-list-zone-scripts-response';
import { AuJBhWMyMessages } from './au-jbh-wmy-messages';
import { AuJBhWMyResultInfo } from './au-jbh-wmy-result-info';
/**
 * 
 * @export
 * @interface InlineResponse4XX243
 */
export interface InlineResponse4XX243 extends AuJBhWMyListZoneScriptsResponse {
    /**
     * 
     * @type {AuJBhWMyMessages}
     * @memberof InlineResponse4XX243
     */
