...
import { Ir4bTFI2SingleResponse } from './ir4b-tfi2-single-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX355
 */
export interface InlineResponse4XX355 extends Ir4bTFI2SingleResponse {
    /**
     * 
     * @type {Ir4bTFI2Messages}
     * @memberof InlineResponse4XX355
     */
