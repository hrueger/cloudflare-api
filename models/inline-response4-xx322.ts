...
import { WaitingroomEventResponse } from './waitingroom-event-response';
import { WaitingroomMessages } from './waitingroom-messages';
/**
 * 
 * @export
 * @interface InlineResponse4XX322
 */
export interface InlineResponse4XX322 extends WaitingroomEventResponse {
    /**
     * 
     * @type {WaitingroomMessages}
     * @memberof InlineResponse4XX322
     */
