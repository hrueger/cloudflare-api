...
import { HrcAXqolIdResponse } from './hrc-axqol-id-response';
import { HrcAXqolMessages } from './hrc-axqol-messages';
/**
 * 
 * @export
 * @interface InlineResponse4XX222
 */
export interface InlineResponse4XX222 extends HrcAXqolIdResponse {
    /**
     * 
     * @type {HrcAXqolMessages}
     * @memberof InlineResponse4XX222
     */
