...
import { ZzQH0lDwSchemasIdResponse } from './zz-qh0l-dw-schemas-id-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX135
 */
export interface InlineResponse4XX135 extends ZzQH0lDwSchemasIdResponse {
    /**
     * 
     * @type {ZzQH0lDwMessages}
     * @memberof InlineResponse4XX135
     */
