...
import { Mpo6O2coSchemasTunnelAddSingleRequest } from './mpo6-o2co-schemas-tunnel-add-single-request';
/**
 * 
 * @export
 * @interface Mpo6O2coSchemasTunnelUpdateRequest
 */
export interface Mpo6O2coSchemasTunnelUpdateRequest extends Mpo6O2coSchemasTunnelAddSingleRequest {
}
