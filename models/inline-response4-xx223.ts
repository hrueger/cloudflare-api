...
import { HrcAXqolSingleResponse } from './hrc-axqol-single-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX223
 */
export interface InlineResponse4XX223 extends HrcAXqolSingleResponse {
    /**
     * 
     * @type {HrcAXqolMessages}
     * @memberof InlineResponse4XX223
     */
