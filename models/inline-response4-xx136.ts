...
import { ZzQH0lDwResponseCollection } from './zz-qh0l-dw-response-collection';
/**
 * 
 * @export
 * @interface InlineResponse4XX136
 */
export interface InlineResponse4XX136 extends ZzQH0lDwResponseCollection {
    /**
     * 
     * @type {ZzQH0lDwMessages}
     * @memberof InlineResponse4XX136
     */
