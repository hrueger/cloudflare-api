...
import { WaitingroomSingleResponse } from './waitingroom-single-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX317
 */
export interface InlineResponse4XX317 extends WaitingroomSingleResponse {
    /**
     * 
     * @type {WaitingroomMessages}
     * @memberof InlineResponse4XX317
     */
