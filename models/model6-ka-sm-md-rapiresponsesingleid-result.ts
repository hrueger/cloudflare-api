 ...
 * 
 * @export
 * @interface Model6KaSmMdRApiresponsesingleidResult
 */
export interface Model6KaSmMdRApiresponsesingleidResult {
    /**
     * 
     * @type {Model6KaSmMdRCommonComponentsSchemasIdentifier}
     * @memberof Model6KaSmMdRApiresponsesingleidResult
     */
