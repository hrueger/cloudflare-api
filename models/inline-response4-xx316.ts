...
import { WaitingroomResponseCollection } from './waitingroom-response-collection';
/**
 * 
 * @export
 * @interface InlineResponse4XX316
 */
export interface InlineResponse4XX316 extends WaitingroomResponseCollection {
    /**
     * 
     * @type {WaitingroomMessages}
     * @memberof InlineResponse4XX316
     */
