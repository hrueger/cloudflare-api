...
import { Model2UOufITZSingleResponseIncoming } from './model2-uouf-itzsingle-response-incoming';
/**
 * 
 * @export
 * @interface InlineResponse4XX282
 */
export interface InlineResponse4XX282 extends Model2UOufITZSingleResponseIncoming {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX282
     */
