 ...
 * 
 * @export
 * @interface C4f8RoOSWebhooksComponentsSchemasIdResponse
 */
export interface C4f8RoOSWebhooksComponentsSchemasIdResponse extends C4f8RoOSApiResponseSingle {
    /**
     * 
     * @type {C4f8RoOSAppsComponentsschemasidResponseResult}
     * @memberof C4f8RoOSWebhooksComponentsSchemasIdResponse
     */
