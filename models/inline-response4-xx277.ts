...
import { Model2UOufITZIdResponse } from './model2-uouf-itzid-response';
import { Model2UOufITZMessages } from './model2-uouf-itzmessages';
/**
 * 
 * @export
 * @interface InlineResponse4XX277
 */
export interface InlineResponse4XX277 extends Model2UOufITZIdResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX277
     */
