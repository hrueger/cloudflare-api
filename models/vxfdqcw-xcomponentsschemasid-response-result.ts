 ...
 * 
 * @export
 * @interface VXFDQCwXComponentsschemasidResponseResult
 */
export interface VXFDQCwXComponentsschemasidResponseResult {
    /**
     * 
     * @type {VXFDQCwXLoadBalancerComponentsSchemasIdentifier}
     * @memberof VXFDQCwXComponentsschemasidResponseResult
     */
