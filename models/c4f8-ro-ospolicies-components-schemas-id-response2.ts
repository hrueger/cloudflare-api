 ...
 * 
 * @export
 * @interface C4f8RoOSPoliciesComponentsSchemasIdResponse2
 */
export interface C4f8RoOSPoliciesComponentsSchemasIdResponse2 extends C4f8RoOSApiResponseSingle {
    /**
     * 
     * @type {C4f8RoOSAppsComponentsschemasidResponseResult}
     * @memberof C4f8RoOSPoliciesComponentsSchemasIdResponse2
     */
