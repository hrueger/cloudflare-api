 ...
 * 
 * @export
 * @interface C4f8RoOSBookmarksComponentsSchemasIdResponse
 */
export interface C4f8RoOSBookmarksComponentsSchemasIdResponse extends C4f8RoOSApiResponseSingle {
    /**
     * 
     * @type {C4f8RoOSAppsComponentsschemasidResponseResult}
     * @memberof C4f8RoOSBookmarksComponentsSchemasIdResponse
     */
