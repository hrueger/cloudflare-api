...
import { Model2UOufITZSchemasForceResponse } from './model2-uouf-itzschemas-force-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX280
 */
export interface InlineResponse4XX280 extends Model2UOufITZSchemasForceResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX280
     */
