...
import { Model2UOufITZEnableTransferResponse } from './model2-uouf-itzenable-transfer-response';
import { Model2UOufITZMessages } from './model2-uouf-itzmessages';
/**
 * 
 * @export
 * @interface InlineResponse4XX279
 */
export interface InlineResponse4XX279 extends Model2UOufITZEnableTransferResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX279
     */
