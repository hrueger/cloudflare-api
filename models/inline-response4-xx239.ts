...
import { AuJBhWMyListZoneConnectionsResponse } from './au-jbh-wmy-list-zone-connections-response';
import { AuJBhWMyMessages } from './au-jbh-wmy-messages';
import { AuJBhWMyResultInfo } from './au-jbh-wmy-result-info';
/**
 * 
 * @export
 * @interface InlineResponse4XX239
 */
export interface InlineResponse4XX239 extends AuJBhWMyListZoneConnectionsResponse {
    /**
     * 
     * @type {AuJBhWMyMessages}
     * @memberof InlineResponse4XX239
     */
