...
import { WaitingroomZoneSettingsResponse } from './waitingroom-zone-settings-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX319
 */
export interface InlineResponse4XX319 extends WaitingroomZoneSettingsResponse {
    /**
     * 
     * @type {WaitingroomMessages}
     * @memberof InlineResponse4XX319
     */
