...
import { Model2UOufITZSingleResponseOutgoing } from './model2-uouf-itzsingle-response-outgoing';
/**
 * 
 * @export
 * @interface InlineResponse4XX276
 */
export interface InlineResponse4XX276 extends Model2UOufITZSingleResponseOutgoing {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX276
     */
