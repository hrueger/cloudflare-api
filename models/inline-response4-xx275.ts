...
import { Model2UOufITZSchemasSingleResponse } from './model2-uouf-itzschemas-single-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX275
 */
export interface InlineResponse4XX275 extends Model2UOufITZSchemasSingleResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX275
     */
