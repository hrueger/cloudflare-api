...
import { C4f8RoOSPackageResponseCollection } from './c4f8-ro-ospackage-response-collection';
/**
 * 
 * @export
 * @interface InlineResponse4xx87
 */
export interface InlineResponse4xx87 extends C4f8RoOSPackageResponseCollection {
    /**
     * 
