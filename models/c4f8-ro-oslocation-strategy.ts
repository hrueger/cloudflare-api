 ...
 * @export
 * @interface C4f8RoOSLocationStrategy
 */
export interface C4f8RoOSLocationStrategy {
    /**
     ...
     * @type {string}
     * @memberof C4f8RoOSLocationStrategy
     */
    mode?: C4f8RoOSLocationStrategyModeEnum;
    /**
     ...
     * @memberof C4f8RoOSLocationStrategy
     */
    preferEcs?: C4f8RoOSLocationStrategyPreferEcsEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum C4f8RoOSLocationStrategyModeEnum {
    Pop = 'pop',
...
/**
    ...
    * @enum {string}
    */
export enum C4f8RoOSLocationStrategyPreferEcsEnum {
    Always = 'always',
    Never = 'never',
    Proximity = 'proximity',
    Geo = 'geo'
