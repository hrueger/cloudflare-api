...
import { WaitingroomStatusResponse } from './waitingroom-status-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX326
 */
export interface InlineResponse4XX326 extends WaitingroomStatusResponse {
    /**
     * 
     * @type {WaitingroomMessages}
     * @memberof InlineResponse4XX326
     */
