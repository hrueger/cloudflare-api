 ...
 * @export
 * @interface Tm1HTKEcSchemasidentityproviderScimConfig
 */
export interface Tm1HTKEcSchemasidentityproviderScimConfig {
    /**
     * A flag to enable or disable SCIM for the identity provider.
     * @type {boolean}
     * @memberof Tm1HTKEcSchemasidentityproviderScimConfig
     */
    enabled?: boolean;
    /**
