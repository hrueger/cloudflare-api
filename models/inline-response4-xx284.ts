...
import { Model2UOufITZSingleResponse } from './model2-uouf-itzsingle-response';
/**
 * 
 * @export
 * @interface InlineResponse4XX284
 */
export interface InlineResponse4XX284 extends Model2UOufITZSingleResponse {
    /**
     * 
     * @type {Model2UOufITZMessages}
     * @memberof InlineResponse4XX284
     */
