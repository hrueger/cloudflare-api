 ...
 * 
 * @export
 * @interface SettingsAutomaticPlatformOptimizationBody
 */
export interface SettingsAutomaticPlatformOptimizationBody {
    /**
     * 
     * @type {Model4tKvLQ4cAutomaticPlatformOptimization}
     * @memberof SettingsAutomaticPlatformOptimizationBody
     */
