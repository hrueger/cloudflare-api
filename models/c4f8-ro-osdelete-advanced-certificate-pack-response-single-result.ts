 ...
 * 
 * @export
 * @interface C4f8RoOSDeleteAdvancedCertificatePackResponseSingleResult
 */
export interface C4f8RoOSDeleteAdvancedCertificatePackResponseSingleResult {
    /**
     * 
     * @type {C4f8RoOSCertificatePacksComponentsSchemasIdentifier}
     * @memberof C4f8RoOSDeleteAdvancedCertificatePackResponseSingleResult
     */
