 ...
 * 
 * @export
 * @interface RulesIdentifierBody1
 */
export interface RulesIdentifierBody1 {
    /**
     ...
     * @type {string}
     * @memberof RulesIdentifierBody1
     */
    cascade?: RulesIdentifierBody1CascadeEnum;
}
...
/**
    ...
    * @enum {string}
    */
export enum RulesIdentifierBody1CascadeEnum {
    None = 'none',
    Basic = 'basic',
