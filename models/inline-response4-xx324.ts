...
import { WaitingroomEventDetailsResponse } from './waitingroom-event-details-response';
import { WaitingroomMessages } from './waitingroom-messages';
/**
 * 
 * @export
 * @interface InlineResponse4XX324
 */
export interface InlineResponse4XX324 extends WaitingroomEventDetailsResponse {
    /**
     * 
     * @type {WaitingroomMessages}
     * @memberof InlineResponse4XX324
     */
