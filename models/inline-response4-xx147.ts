...
import { ZzQH0lDwDeviceResponse } from './zz-qh0l-dw-device-response';
import { ZzQH0lDwMessages } from './zz-qh0l-dw-messages';
/**
 * 
 * @export
 * @interface InlineResponse4XX147
 */
export interface InlineResponse4XX147 extends ZzQH0lDwDeviceResponse {
    /**
     * 
     * @type {ZzQH0lDwMessages}
     * @memberof InlineResponse4XX147
     */
