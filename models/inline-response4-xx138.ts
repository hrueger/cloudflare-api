...
import { ZzQH0lDwIdResponse } from './zz-qh0l-dw-id-response';
import { ZzQH0lDwMessages } from './zz-qh0l-dw-messages';
/**
 * 
 * @export
 * @interface InlineResponse4XX138
 */
export interface InlineResponse4XX138 extends ZzQH0lDwIdResponse {
    /**
     * 
     * @type {ZzQH0lDwMessages}
     * @memberof InlineResponse4XX138
     */
